...
const Header = () => {
    ...
    return (
        <header class="w-full bg-gradient-to-r from-orange-600 via-orange-500 to-orange-500 px-6 py-4 flex justify-between items-center shadow-md">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="text-white text-sm text-right">
                    ...
                    <p className="opacity-70">DIC Officer</p>
                </div>
