...
const UnitRegistration = () => {
    ...
    useEffect(() => {
        setPageTitle("New Unit Registration");
        setPageSubTitle("Information Architecture: Form (Application for Registration)");
        setBackButton(<BackButton label="Back to Units" />);
        ...
        <>
            <div className="bg-white p-6 rounded-xl shadow overflow-x-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="text-sm font-medium text-gray-700">Name of the Indutrial unit</label>
                        <input
                            type="text"
                ...
                <div className="space-y-1">
                    <h3 className="text-lg font-semibold border-b-2 border-gray-800 pb-1">Address Details</h3>
