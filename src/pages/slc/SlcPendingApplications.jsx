...
const SlcPendingApplications = () => {
    // Mock Data for Pending
    const applications = [
        {
            id: "APP-2024-001",
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50 text-gray-600 text-sm uppercase tracking-wider">
                                ...
                                <th className="p-4 font-semibold border-b text-right">Financial Impact</th>
                        ...
                        <tbody className="text-sm divide-y divide-gray-100">
                            {applications.map((app) => (
                                <tr key={app.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="p-4 text-gray-800 font-medium text-right">{app.financialImpact}</td>
...
export default SlcPendingApplications;
